...
export const de: Messages = {
  ...
  'ds.auth.static': 'Zugriffsschlüssel (in diesem Browser gespeichert)',
  'ds.auth.none': 'Keine (öffentlicher Bucket)',
  'ds.key.title': 'Zugriffsschlüssel',
  'ds.key.warn': 'Schlüssel werden im localStorage dieser Erweiterung gespeichert. Bevorzugen Sie temporäre Anmeldedaten (Session-Token) oder die OIDC-Anmeldung.',
  ...
  'ds.history.hint': 'Die letzten {n} verbundenen S3-/HTTPS- und Demo-Quellen, neueste zuerst. Eine Auswahl lädt deren Einstellungen (einschließlich Schlüssel und gewählter Musterwerte) und verbindet; das Menü in der Kopfzeile tut dasselbe von jeder Seite aus.',

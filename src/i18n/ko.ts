...
export const ko: Messages = {
  ...
  'src.gzDirect': 'gzip 파일을 DuckDB가 직접 읽습니다 ({reason}). 연결된(concatenated) gzip 객체는 실패하거나 행이 누락될 수 있습니다',
  'src.fetchingGz': 'gzip 파일 {n}개 가져오는 중…',
  'src.fetchingGzProgress': 'gzip 파일 가져오는 중… {done} / {total} ({bytes} 다운로드됨)',
  'src.repacked': '연결된(concatenated) gzip 파일 {n}개를 DuckDB용으로 다시 압축했습니다',
  'src.gzFailed': 'gzip 파일 {n}개를 가져오지 못했습니다 (DuckDB가 직접 읽음): {error}',

...
export const ko: Messages = {
  ...
  'ds.auth.static': '액세스 키 (이 브라우저에 저장)',
  'ds.auth.none': '없음 (공개 버킷)',
  'ds.key.title': '액세스 키',
  'ds.key.warn': '키는 이 확장 프로그램의 localStorage에 보관됩니다. 임시 자격 증명(세션 토큰) 또는 OIDC 로그인을 권장합니다.',
  'ds.key.id': '액세스 키 ID',
  ...
  'ds.history.hint': '최근에 연결한 S3 / HTTPS 및 데모 소스 {n}개(최신순)입니다. 선택하면 해당 설정(키와 선택한 패턴 변수 값 포함)을 불러와 연결합니다. 헤더의 메뉴에서도 어느 페이지에서나 같은 작업을 할 수 있습니다.',
  'ds.history.use': '연결',

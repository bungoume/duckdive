...
export const en = {
  ...
  'ds.auth.static': 'Access key (stored in this browser)',
  'ds.auth.none': 'None (public bucket)',
  'ds.key.title': 'Access key',
  'ds.key.warn': "Keys are kept in this extension's localStorage. Prefer temporary credentials (session token) or the OIDC sign-in.",
  ...
  'ds.history.hint': 'The last {n} S3 / HTTPS and demo sources that were connected, newest first. Choosing one loads its settings (including keys and chosen pattern values) and connects; the header menu does the same from any page.',

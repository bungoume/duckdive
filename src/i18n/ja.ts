...
export const ja: Messages = {
  ...
  'app.progress.openingLocal': 'ローカルファイルを開いています…',
  ...
  'settings.backup.hint':
    'このブラウザに保存されているもの(設定、言語、保存済み検索と可視化、最近のソース、クエリと SQL の履歴)を 1 つのファイルにします。秘密情報と、確認済み SQL の一覧は含まれません。復元したカスタム SQL フィルターは、内容を読むまで無効のままです。ローカルファイルは復元先で選び直す必要があります。',
  ...
  'ds.local.drop': 'Parquet / CSV / JSON のファイル、またはそれらのフォルダをここにドロップ',
  'ds.local.chooseFiles': 'ファイルを選択…',
  'ds.local.chooseFolder': 'フォルダを選択…',
  'ds.local.selected': '{n} ファイル: {names}',
  'ds.local.clear': 'クリア',
  'ds.local.remembered': '記憶済み: {names}。Connect を押すと Chrome が再度読み取り許可を求めます。',
  'ds.local.hint': 'ファイルはブラウザの File API でその場で読み込まれ、アップロードされることはありません。ここで選んだものは最近のソースに記憶され、再起動後は Chrome が再度読み取り許可を求めます。',
  ...
  'disc.breakdown': '内訳',
  'disc.noBreakdown': '内訳なし',
  'disc.interval': '間隔',
  'disc.empty.title': '検索条件に一致する結果がありません',
  'disc.empty.text': '時間範囲を広げるか、クエリやフィルタを調整してください。',
  'disc.loadMore': 'さらに読み込む({shown} / {total})',
  'disc.saved': '保存済み検索',
  'disc.saved.placeholder': '名前(空ならクエリ文字列)',
  'disc.saved.untitled': '検索 {n}',
  'disc.saved.none': 'まだ何も保存されていません。保存した検索はこのブラウザ(localStorage)に保持されます。',
  'disc.cacheHint':
  ...
  // ---- dashboard ----
  'dash.hint': '上の検索条件と時間範囲で保存済みの可視化を並べて表示します。グラフをクリックするとすべてにフィルタやズームが適用されます。',
  'dash.add': '可視化を追加',
  'dash.allAdded': '保存済みの可視化はすべてダッシュボードに載っています。',
  'dash.noneSaved': 'まだ何も保存されていません。先に Visualize ページで可視化を保存してください。',
  'dash.empty.title': 'ダッシュボードは空です',
  ...
  'vis.groupOther': '残りを「その他」にまとめる',
  'vis.other': 'その他',
  'vis.options': 'オプション',
  'vis.opt.percent': '100 % 積み上げ',
  'vis.opt.log': '対数軸',
  'vis.opt.compare': '前の期間と比較',
  'vis.percentile': 'パーセンタイル(0–100)',
  'vis.previousNote': '破線: 同じ長さの前の期間。',
  'vis.downloadSvg': 'SVG',
  'vis.downloadSvg.title': 'グラフを SVG ファイルとしてダウンロード',
  ...
  'src.local.emptyFolder': 'フォルダに Parquet / CSV / JSON ファイルがありません',
  'src.local.forgotten': 'このソースのファイルをブラウザが覚えていません。もう一度選択してください。',
  'src.local.denied': 'Chrome がファイルへのアクセスを許可しませんでした。',

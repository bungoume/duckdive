...
export const fr: Messages = {
  ...
  'ds.auth.static': "Clé d'accès (stockée dans ce navigateur)",
  'ds.auth.none': 'Aucune (bucket public)',
  'ds.key.title': "Clé d'accès",
  'ds.key.warn': 'Les clés sont conservées dans le localStorage de cette extension. Préférez des identifiants temporaires (jeton de session) ou la connexion OIDC.',
  ...
  'ds.history.hint': "Les {n} dernières sources S3 / HTTPS et démo connectées, la plus récente en premier. En choisir une charge ses réglages (clés et valeurs de variables comprises) et connecte ; le menu de l'en-tête fait de même depuis n'importe quelle page.",

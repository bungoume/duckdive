...
export const fr: Messages = {
  ...
  'app.progress.openingLocal': 'Ouverture des fichiers locaux…',
  ...
  'ds.naming': 'Noms des champs',
  'ds.naming.hint':
    "Les noms OpenTelemetry s'appliquent aux formats que duckdive reconnaît comme une famille de journaux (ALB, CloudFront, accès S3, CloudTrail, WAF, Route 53 Resolver, VPC Flow Logs, Cloud Logging, Logpush) ; Parquet, CSV et JSON simple conservent les noms qu'ils livrent. Les recherches et visualisations enregistrées nomment des champs : elles ne passent donc pas de l'un à l'autre.",
  'ds.name': 'Nom',
  ...
  'ds.local.drop': 'Déposez ici des fichiers Parquet, CSV ou JSON, ou un dossier qui en contient',
  'ds.local.chooseFiles': 'Choisir des fichiers…',
  'ds.local.chooseFolder': 'Choisir un dossier…',
  'ds.local.selected': '{n} fichier(s) : {names}',
  'ds.local.clear': 'Effacer',
  'ds.local.remembered': 'Mémorisé : {names}. À la connexion, Chrome redemande l’autorisation de lire les fichiers.',
  'ds.local.hint':
    "Les fichiers sont lus sur place via l'API File du navigateur ; ils ne sont jamais téléversés. La sélection est mémorisée dans les sources récentes ; après un redémarrage, Chrome redemande l'autorisation de lecture.",
  'ds.demo.hint':
  ...
  // ---- file formats ----
  'naming.native': 'Tels que livrés (noms du journal)',
  'naming.otel': 'Conventions sémantiques OpenTelemetry',
  ...
  'src.local.emptyFolder': 'Le dossier ne contient aucun fichier Parquet, CSV ou JSON',
  'src.local.forgotten': 'Le navigateur ne connaît plus les fichiers de cette source ; choisissez-les à nouveau.',
  'src.local.denied': 'Chrome n’a pas accordé l’accès aux fichiers.',
